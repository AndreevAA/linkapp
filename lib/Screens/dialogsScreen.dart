          ...
          children: <Widget>[
            InkWell(
              onTap: () async {
                ...
                Navigator.push (
                  context,
                  MaterialPageRoute(builder: (context) => OrderChatView(chatUid: document.documentID, listOfUids: (document['users'] as List).cast<String>().toList(),)),
                );
              },
              child: Row(
                children: <Widget>[
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Text(
                          document['names'][0] == UserSettings.userDocument['name'] ? document['names'][1] : document['names'][0],
...
//                ),
                      ...
                      Container(
                        ...
                        child: Text(
                          // concatMinMax(document['min_price'], document['max_price']) +
                          // " / " + document['pay_type'] ?? "",
                          (((document['messages'] ?? [null])[0] ?? {"text" : "Напишите сообщение!"})['text'] ?? "er").toString().substring(0, (((document['messages'] ?? [null])[0] ?? {"text" : "Напишите сообщение!"})['text'] ?? "er").length > 16 ? 16 : (((document['messages'] ?? [null])[0] ?? {"text" : "Напишите сообщение!"})['text'] ?? "er").length) + "...",
                          style: TextStyle(
                              fontSize: 11.0,
