...
class UserInputDataVerification {
  ...
  static String _allCapitalsRus = "абвгдеёжзийклмнопрстуфхцчшщъыьэюя1234567890-+_><?:!.,;()/*@#=][}{`~₽ AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvXxYyZz";
  ...
  static bool isInputBirthday(String _birthday){
    ...
    // Проверка на длину
    if (date.year - int.parse(_birthday) <= 4)
      answer = false;
...
class _ProfileDataEditing extends State<ProfileDataEditing> {
  ...
  Future<dynamic> showConfirmation(BuildContext context){
    ...
    if (UserInputDataVerification.isInputNameRight(_name) == true && UserInputDataVerification.isInputSurnameRight(_surname) == true && UserInputDataVerification.isInputBirthday(_birthday) == true)
    {
      return showDialog(
          context: context,
          ...
          builder: (BuildContext context) {
            return new AlertDialog(
              ...
              title: Text('Вы уверены, что хотите обновить данные?', textAlign: TextAlign.center, style: TextStyle(
              ...
              content: Row(
                ...
                children : <Widget>[
                  ...
                  Container(
                    ...
                    child: _loading ? CircularProgressIndicator() : FlatButton(
                        color: BlockColors.accentColor,
                        shape: RoundedRectangleBorder(
                            borderRadius: new BorderRadius.circular(5.0),
                            side: BorderSide(color: BlockColors.accentColor)
                        ),
        ...
        appBar: AppBar(
          title: Container(
            child: InkWell(
              ...
              child: Text('      Настройки', style: TextStyle(color: Colors.black), textAlign: TextAlign.center,),
            )
          ),
          leading: BackButton(
            color: Colors.black,
                ...
                new Container(
                  ...
                  margin: const EdgeInsets.only(left: 10.0, right: 10.0),
                    ...
                    Container(
                      padding: const EdgeInsets.fromLTRB(10, 0, 0, 0),
                      child: Text(
                        "КОНТАКТЫ", textAlign: TextAlign.left, style: TextStyle(
                    ...
                    Container(
                      padding: const EdgeInsets.fromLTRB(10, 0, 0, 0),
                      child: Text(
                        "Имя", textAlign: TextAlign.left, style: TextStyle(
                        color: Colors.black, fontSize: 14,
                      ),
                      ),
                    ),
                    ...
                    Container(
                      padding: const EdgeInsets.fromLTRB(10, 0, 0, 0),
                      child: Text(
                        "Имя может содержать только символы русского языка, знаки пробела и тире", textAlign: TextAlign.left, style: TextStyle(
                    ...
                    Container(
                      padding: const EdgeInsets.fromLTRB(10, 0, 0, 0),
                      child: Text(
                        "Фамилия", textAlign: TextAlign.left, style: TextStyle(
                        color: Colors.black, fontSize: 14,
                      ),
                      ),
                    ),
                    ...
                    Container(
                      padding: const EdgeInsets.fromLTRB(10, 0, 0, 0),
                      child: Text(
                        "ИНФОРМАЦИЯ", textAlign: TextAlign.left, style: TextStyle(
                        color: Colors.black, fontSize: 12, fontWeight: FontWeight.w300,
                      ),
                      ),
                    ),
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Text(
                            "Пол", textAlign: TextAlign.left, style: TextStyle(
                            color: Colors.black, fontSize: 14,
                          ),
                          ),
                        ),
                        ...
                        RadioButtonGroup(
                          ...
                          onSelected: (String selected) => setState((){_gender = selected;}),
                        ),
                      ],
                    ),
                    ...
                    Row(
                      children: <Widget>[
                        ...
                        Container(
                          padding: const EdgeInsets.fromLTRB(10, 0, 0, 25),
                          child: Text(
                            "Статус РФ", textAlign: TextAlign.left, style: TextStyle(
                            color: Colors.black, fontSize: 14,
                          ),
                          ),
                        ),
                        ...
                        RadioButtonGroup(
                            ...
                            picked: _patent == "patent" || _patent == "patent_confirmed" ? " Патент " : _patent == "residence" ? " Гражданство " : " Нет",
                    ...
                    Container(
                      padding: const EdgeInsets.fromLTRB(10, 0, 0, 0),
                      child: Text(
                        "Дата рождения", textAlign: TextAlign.left, style: TextStyle(
                        color: Colors.black, fontSize: 14,
                      ),
                      ),
                    ),
                    ...
                    Container(
                      padding: const EdgeInsets.fromLTRB(10, 0, 0, 0),
                      child: Text(
                        "Приложением могут пользоваться только лица старше четырех лет", textAlign: TextAlign.left, style: TextStyle(
                        color: Colors.black38, fontSize: 11,
                      ),
                      ),
                    ),
                    ...
                    Container(
                      padding: const EdgeInsets.fromLTRB(10, 0, 0, 0),
                      child: Text(
                        "Гражданство", textAlign: TextAlign.left, style: TextStyle(
                        color: Colors.black, fontSize: 14,
                      ),
                      ),
                    ),
